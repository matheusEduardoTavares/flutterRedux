...
///e redux. No Redux terems sempre o [AppState] que é o estado
///geral da aplicação, e podemos ter vários reducers para 
///separar os outros estados.
  ...
  Widget build(BuildContext context) {
    ...
    return StoreProvider(
      ...
      child: StoreConnector<AppState, int>(
        ...
        builder: (_, counterX) => MaterialApp(
        title: 'Flutter Demo',
        ...
        home: MyHomePage(title: 'counterX = $counterX'),
      ),
      ),
    );
